...
public class PermanentEmployeePaySlipTest {
	
	private static TaxCalculation taxCalculation;
	
	@BeforeClass
	public static void loadPropertiesAndTaxImplementation() {
		taxCalculation =TaxFactory.getInstance(ApplicationProperties.getInstance().load()).
	...
	public void annualSalaryWith60050() {
		...
		emp1.setTaxCalculation(taxCalculation);
